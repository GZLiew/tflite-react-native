...
class Tflite {
  loadModel(args: LoadModelArgs, callback: any) {
  ...
  runModelOnImage(args: any, callback: any) {
  ...
  detectObjectOnImage(args: any, callback: any) {
  ...
  runSegmentationOnImage(args: any, callback: any) {
  ...
  runPoseNetOnImage(args: any, callback: any) {
